...
public:
    ...
    std::string dh_a="0", std::string dh_alpha="0", std::string dh_d="0", std::string dh_theta="0");
    ...
    inline float4 & getJointDHParam(const int joint) { return _dh_params[joint]; }
    ...
    inline const float4 & getJointDHParam(const int joint) const { return _dh_params[joint]; }
