...
public:
    ...
    inline float4 & getJointDHParam(const int joint) { return _jointDHParams->hostPtr()[joint]; }
    ...
    inline const float4 & getJointDHParam(const int joint) const { return _jointDHParams->hostPtr()[joint]; }
...
private:
    ...
    MirroredVector<float4> * _jointDHParams;
