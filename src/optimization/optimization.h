...
struct OptimizationOptions {
    ...
    float contactRegularization;                    /**< Regularization for the contact priors */
    ...
    float regularizationScaledThresh;
    float contactRegularizationScaled;              /**< LM damping for the contact prior */
    float contactRegularizationScaledThresh;
    ...
    OptimizationOptions() :
        ...
        regularizationScaledThresh(100.f),
        contactRegularizationScaled(1.f),
        contactRegularizationScaledThresh(100.f),
